...
CATEGORIES = {
    ...
    "gods": {
        ...
        "commands": [
            ...
            ("!envoy list",                      "Show current envoy spawn status"),
            ("!envoy pool [number]",             "View or set the envoy loot pool number (admin)"),
    ...
    "skills": {
        ...
        "emoji": "✨",
        "description": "Cast skills and use potions. Classic names (`!cast-ss`, `!cast-raid`…) still work.",
        "commands": [
            ("!cast <skill> <target>",           "Cast any named skill on a crew, group, or character"),
            ("!cast raid <target>",              "Cast the full boss-raid skill set (except SiN)"),
            ("!cast ss <group>",                 "Cast Street Smarts on a group or crew"),
            ("!cast misc <target>",              "Cast Shield Wall, God Slayer, Triworld Influence"),
            ("!cast pres <target>",              "Cast the Preservation raid skills"),
            ("!cast fero <target>",              "Cast all Ferocity skills (DC/PvP — rarely used)"),
            ("!cast afflic <target>",            "Cast all Affliction skills (DC/PvP — rarely used)"),
            ("!cast class <target>",             "Cast Empower, Stealth, VitaminX, Fortify, Masterful Pres"),
    ...
    "admin": {
        ...
        "commands": [
            ("!trustee scan",                    "Scrape trustee list from Outwar"),
            ("!trustee update",                  "Reload trustees without restarting"),
            ("!trustee check",                   "List all trusted accounts"),
